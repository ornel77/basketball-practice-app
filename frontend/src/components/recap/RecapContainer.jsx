...
const RecapContainer = () => {
  ...
  return (
    <div className="relative z-40">
      <div>
        <img src="/joueur_victore.png" alt="joueur_victoire" className="fixed bottom-12 -left-10 w-40 -z-40 opacity-70" />
        <img src="/joueuse_victoire.png" alt="joueuse_victoire" className="fixed right-0 top-0 w-32 -z-10 opacity-70" />
      </div>
      {/* Redirect button */}
      <div>
